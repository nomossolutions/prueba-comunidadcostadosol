  ...
  return (
    <div className='principalContainer'>
      <section className="intro">
        <h1><i className="bi bi-star-fill text-secondary me-2"></i> Eventos</h1>
      </section>

      <section className="info-group">
        <div className="card-info text-center">
          <h2><i className="bi bi-calendar-check me-2 text-secondary"></i> Ágape Aniversário da Igreja</h2>
          <p className="fs-5">Domingo 11/01/2026 - 19:00 hs.</p>
          <div className="mt-4">
